...
import com.bdg.airport_management_system.ReadFile;
import com.bdg.airport_management_system.model.Company;
import com.bdg.airport_management_system.dao.CompanyDao;
...
import static com.bdg.airport_management_system.ReadFile.fromFileToList;
...
public class CompanyDaoImpl implements CompanyDao {
    ...
    public Company update(Company passenger) {
        try {
            ...
            statement.setInt(3, (int) passenger.getId());
